...
private:
	...
	const char* playbinBackendName() const;
	bool hasPlaybinProperty(const char* property) const;
	void logPlaybinProperties() const;
	void logPlaybinStartup(const gchar* uri, guint flags) const;
